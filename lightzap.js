...
(function () {
	...
	var baseURL, imgNotFound, windowWidth, windowHeight, originalWidth, originalHeight, isfull = false, marginWidth = -1, marginHeight = -1;
	...
	LightZAP = (function () {
		...
		LightZAP.prototype.sizeOverlay = function () {
			...
			if (windowWidth != $(window).width() || windowHeight != $(window).height()) {
				...
				if (!isfull)
					isfull = (windowWidth >= screen.width * 0.99 && windowHeight >= screen.height * 0.99);
		...
		LightZAP.prototype.print = function () {
   		...
   		LightZAP.prototype.like = function () {
			...
			var href = "http://www.facebook.com/sharer/sharer.php?u=" + baseURL + album[lz.currentImageIndex].link.replace(baseURL,'') + "&t=" + album[lz.currentImageIndex].title;
